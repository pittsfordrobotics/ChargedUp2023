...
public class EndEffectorIOSparkMax implements EndEffectorIO {
    private final LazySparkMax motor = new LazySparkMax(Constants.EndEffectorConstants.CAN_LEFT, CANSparkMax.IdleMode.kBrake, 30, true, false); // currentlimit stolen from 2022 intake
