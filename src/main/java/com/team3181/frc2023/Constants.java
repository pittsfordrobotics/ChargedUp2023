...
public final class Constants {
    ...
    public static final class SwerveConstants {
        ...
        public static final double DIRECTION_RATE_LIMIT = 1.2; // radians per second
        public static final double MAGNITUDE_RATE_LIMIT = 1.8; // percent per second (1 = 100%)
        public static final double ROTATION_RATE_LIMIT = 2.0; // percent per second (1 = 100%)
    }
